...
### 💰 [YNAC](https://github.com/mbrajk/ynac) - YNAB Console Application
...
- **Tech Stack:** C#
- **Focus:** Search algorithms, document processing, performance optimization
- **Status:** Recent active development

### 🗺️ [Java Google Static Map Builder](https://github.com/mbrajk/java-google-static-map-builder)
Java library for programmatically building Google Static Map URLs and retrieving map images.
- **Tech Stack:** Java, Google Maps API
- **Use Case:** Location-based applications, map generation
- **License:** MIT

### 🎵 [Strudel.cc Collection](https://github.com/mbrajk/strudel.cc)
Creative coding project featuring algorithmic music compositions using Strudel.cc.
...
**Technologies:** .NET, Google APIs, YNAB API, Blazor  
**Specialties:** Console applications, API integration, financial tools, design patterns  
**Interests:** Document processing, creative coding, algorithmic music
...
- 🔧 Enhancing YNAC with new budget management features
- 📚 Expanding the design patterns collection with more real-world examples
- 🎵 Exploring generative music algorithms with Strudel.cc

## 📫 Let's Connect

- 🌐 **Website:** [mike.brajkovich.me](https://mike.brajkovich.me)
- 💼 **GitHub:** [@mbrajk](https://github.com/mbrajk)

---
*"Building practical solutions while exploring the creative intersection of code and music."*